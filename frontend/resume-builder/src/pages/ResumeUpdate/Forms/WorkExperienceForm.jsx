...
export default function WorkExperienceForm({workExperience, updateArrayItem, addArrayItem, removeArrayItem}) {
  return (
        ...
        {workExperience.map((experience, index)=>(
          ...
          className='border border-gray-200/80 p-4 rounded-lg relative'>
            ...
            <div className='mt-4'>
              ...
              onChange={({target})=>updateArrayItem(index, "description", target.value)}></textarea>
            </div>
