...
export default function EducationDeatailsForm({educationInfo, updateArrayItem, addArrayItem, removeArrayItem}) {
  return <div className='px-5 pt-5'>
    <h2 className='text-lg font-semibold text-shadow-gray-900'>Education</h2>
      ...
      {educationInfo.map((education, index)=>(
        ...
        className='border border-gray-200/80 p-4 rounded-lg relative'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <Input
            label="Degree"
            placeholder="B.Techin Computer Science"
            type="text"
