...
export default function WorkExperience({company, role, duration, durationColor, description}) {
  return <div className='mb-5'>
    <div className='flex items-start justify-between'>
        ...
        <p className='text-xs fonr-bold italic' style={{color: durationColor}}>{duration}</p>
    </div>
