...
export default function TemplateTwo({ resumeData, colorPalette, containerWidth }) {
    ...
    useEffect(() => {
        // Calculate the scale factor based on conatiner width
            ...
            <div className='mx-10 pb-5'>
                ...
                <div className='grid grid-cols-2 gap-10 mt-4'>
                    ...
                    {resumeData.interests.length > 0 &&
                        resumeData.interests[0] != "" && <div className=''>
